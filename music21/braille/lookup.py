...
textExpressions = {
    'crescendo': _B[345] + _B[14] + _B[1235] + _B[3],
...
symbols = {
    ...
    'cut': _B[456] + _B[14],
    'music_hyphen': _B[5],
    # transcriber-added_sign is same as music hyphen. Degarmo chp 5; GT N. 9, 4.1, 5.2
