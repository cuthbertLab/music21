...
class Test(unittest.TestCase):
    ...
    def testSearch03(self):
        ...
        self.assertEqual(pathInfo, [
            (u'essenFolksong/han1.abc', 268),
            (u'essenFolksong/han1.abc', 269),
            (u'essenFolksong/han1.abc', 270),
            (u'essenFolksong/han1.abc', 271),
            (u'essenFolksong/han1.abc', 272),
            (u'essenFolksong/han1.abc', 273),
            (u'essenFolksong/han1.abc', 334),
            (u'essenFolksong/han1.abc', 527),
            (u'essenFolksong/han1.abc', 528),
            (u'essenFolksong/han1.abc', 529),
            (u'essenFolksong/han2.abc', 203),
            (u'essenFolksong/han2.abc', 204),
            (u'essenFolksong/han2.abc', 205),
            (u'essenFolksong/han2.abc', 206),
            (u'essenFolksong/han2.abc', 207),
            (u'essenFolksong/han2.abc', 208),
            (u'essenFolksong/han2.abc', 209),
            (u'essenFolksong/han2.abc', 210),
            (u'essenFolksong/han2.abc', 211),
            (u'essenFolksong/han2.abc', 212),
            (u'essenFolksong/han2.abc', 213),
            (u'essenFolksong/han2.abc', 214),
            (u'essenFolksong/han2.abc', 215),
            (u'essenFolksong/han2.abc', 216),
            (u'essenFolksong/han2.abc', 217),
            (u'essenFolksong/han2.abc', 218),
            (u'essenFolksong/han2.abc', 219),
            ])
