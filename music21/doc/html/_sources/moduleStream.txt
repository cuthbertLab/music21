...
.. class:: Stream
    ...
    **Stream** **properties**
    ...
    Return all :class:`~music21.pitch.Pitch` objects found in any element in the Stream as a Python List. (since Pitches have no duration, it's a list not a stream) 
