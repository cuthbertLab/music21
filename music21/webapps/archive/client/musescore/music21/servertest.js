...
function run() {
    ...
    var file   = new QFile(pluginPath + "/m21codeinterface.ui");
...
function submitDialog() {
    ...
    var url = "http://ciconia.mit.edu/music21/wsgiservertest";

	var http = new QHttp();
	http.setHost("ciconia.mit.edu", 80);
...
var mscorePlugin =
{
   majorVersion: 1,
   minorVersion: 1,
   menu: 'Plugins.Music21.WSGI Server Test',
   init: init,
   run: run,
   onClose: close
};
