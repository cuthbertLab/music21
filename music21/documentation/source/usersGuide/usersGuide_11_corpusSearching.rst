...
::
    ...
    >>> sixEight
    <music21.metadata.bundles.MetadataBundle {2167 entries}> 

To work with these 2167 pieces, you can parse treat the MetadataBundle
...
::
    ...
    <music21.metadata.bundles.MetadataBundle 'core': {14421 entries}>
