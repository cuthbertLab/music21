...
# This is the READTHEDOCS config file for sphinx. Not the one run by documentation/make.py
# update this as the other one is changed.
...
if os.environ.get('READTHEDOCS', ''):
    ...
    # db runBuild puts the file in a directory under the .egg file, not
    # where things need to be built.  We will copy them to the right place...
    autogenBuild = '../../../../../envs/latest/lib/python3.4/site-packages/music21-3.0.1-py3.4.egg/music21/documentation/autogenerated'
    autogenOut = '/home/docs/checkouts/readthedocs.org/user_builds/music21/checkouts/latest/music21/documentation/autogenerated'

    print("****************INDIR***************")
    print(autogenBuild)
    print(os.path.abspath(autogenBuild))
    print(os.path.join(os.path.dirname(docMaker.__file__), 'autogenerated'))
    ...
    print("**** {0} files copied".format(numCopied))
    print("*******************LISTING DIRS*********************")
