...
from music21.stream import Element, Stream
...
def hdStringToNote(contents):
    ...
    if contents.count('`'):
        ...
        raise HumdrumException("Attacca mark found -- what is that?  I cannot find any references to attacca marks anywhere!")
    if contents.count('~'):
