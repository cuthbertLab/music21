...
def getVerticalityFromObject(music21Obj, scoreObjectIsFrom, classFilterList=None):
    ...
    <music21.voiceLeading.Verticality
        contentDict={0: [<music21.instrument.Piano 'P1: Soprano: Instrument 1'>,
                         <music21.clef.TrebleClef>,
                         <music21.key.Key of f# minor>,
                         <music21.meter.TimeSignature 4/4>,
                         <music21.note.Note C#>],
              1: [<music21.instrument.Piano 'P2: Alto: Instrument 2'>,
                  <music21.clef.TrebleClef>,
                  <music21.key.Key of f# minor>,
                  <music21.meter.TimeSignature 4/4>,
                  <music21.note.Note E>],
              2: [<music21.instrument.Piano 'P3: Tenor: Instrument 3'>,
                  <music21.clef.BassClef>,
                  <music21.key.Key of f# minor>,
                  <music21.meter.TimeSignature 4/4>,
                  <music21.note.Note A>],
              3: [<music21.instrument.Piano 'P4: Bass: Instrument 4'>,
                  <music21.clef.BassClef>,
                  <music21.key.Key of f# minor>,
                  <music21.meter.TimeSignature 4/4>,
                  <music21.note.Note A>]}>
