...
class Modifier(object):
    ...
    '''
    def __init__(self, modifierData, modifierString):
...
class NoteToken(NoteOrRestToken):
    ...
    def _addAccidental(self, n, alter, pm, t):
        ...
        '''
        n.pitch.accidental = pitch.Accidental(alter)
        if self.isEditorial:
            n.editorial.ficta = n.pitch.accidental
        t = re.sub(pm, '', t)
        return t
...
class Converter(object):
    ...
    def parseOne(self, i, t):
        ...
        for s in self.activeStates[:]: # iterate over copy so we can remove....
            s.affectTokenAfterParse(m21Obj)
