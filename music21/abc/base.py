...
class ABCToken(object):
    ...
    def __repr__(self):
        return '<music21.abc.base.ABCToken %r>' % self.src
...
class ABCMetadata(ABCToken):
    ...
    def __repr__(self):
        return '<music21.abc.base.ABCMetadata %r>' % self.src
...
class ABCBar(ABCToken):
    ...
    def __repr__(self):
        return '<music21.abc.base.ABCBar %r>' % self.src
...
class ABCAccent(ABCToken):
    ...
    def __repr__(self):
        return '<music21.abc.base.ABCAccent %r>' % self.src 
...
class ABCStraccent(ABCToken):
    ...
    def __repr__(self):
        return '<music21.abc.base.ABCStraccent %r>' % self.src
...
class ABCTenuto(ABCToken):
    ...
    def __repr__(self):
        return '<music21.abc.base.ABCTenuto %r>' % self.src
...
class ABCGraceStart(ABCToken):
    ...
    def __repr__(self):
        return '<music21.abc.base.ABCGraceStart %r>' % self.src
...
class ABCGraceStop(ABCToken):
    ...
    def __repr__(self):
        return '<music21.abc.base.ABCGraceStop %r>' % self.src    
...
class ABCBrokenRhythmMarker(ABCToken):
    ...
    def __repr__(self):
        return '<music21.abc.base.ABCBrokenRhythmMarker %r>' % self.src
...
class ABCNote(ABCToken):
    ...
    def __repr__(self):
        return '<music21.abc.base.ABCNote %r>' % self.src
...
class ABCChord(ABCNote):
    ...
    def __repr__(self):
        return '<music21.abc.base.ABCChord %r>' % self.src
