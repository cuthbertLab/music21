...
class SFApp():
    ...
    def __init__(self, master):
        ...
        box = Tkinter.Entry(master,width=2*self.sizeButton)
...
#                print 'pas2'
        ...
        b = Tkinter.Button(master, text="Submit score name", width=2*self.sizeButton, command=callback)
        b.grid(row=1,column=3,columnspan=2,padx=0)
        ...
        self.textVar3.set('Notifications') 
        self.label3 = Tkinter.Label(master,width=2*self.sizeButton,textvariable=self.textVar3)
    ...
    def initializeScore(self):
        ...
        for i in scNotes:
            ...
            noteCounter +=1
        print "resuts",self.beginningPages
        print 'dos',self.middlePages
...
class RecordThread(threading.Thread):
    ...
    def run(self):
        ...
        self.result = self.object.repeatTranscription()
        self.outQueue.put(1)
